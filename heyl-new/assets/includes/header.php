...
<body>
	<header>
		<div class="container container--full-width container--flex ai--c jc--c padding--lg">
			<div class="nav container container--1200 container--flex">
				<img class="header__logo--img" src="assets/images/dist/logo.png" alt="Company Logo">
				...
				<div class="nav__phone container--flex">
					<span class="desktop-hidden container--flex"><a href="#"><button class="button button--primary container--flex ai--c jc--c padding--md margin--sm"><span class="desktop-hidden container--flex">Call Us!</span></button></a></span>
				</div>
				<span class="desktop-visible">
					...
					-->
					<a href="tel:<?php echo $phone; ?>"><button class="button button--primary container--flex ai--c jc--c padding--md margin--sm"><span class="desktop-visible"><?php echo $phone; ?></span></button></a>
				</span>
			</div>
		</div>
		...
		<div id="thisContent" class="header__nav--mobile container--column-sm container">
			...
			<!-- this div becomes hidden while viewing mobile nav -->
				<section id="campaign" class="container container--full-width campaign-bg container--flex relative">
					<div class="campaign__photo container--flex">
					</div>
					<div class="campaign__text padding--lg container--flex">
						<div>
							<h1 style="font-size: 2em;" class="margin--md">Earn more when you're driving - and when you're not.</h1>
							<p class="margin--md">With new higher rates for mileage and previous experience, you'll make better money whether you're on the go or stopped.</p>
							<div class="container campaign__buttons--container container--flex wrap">
								<a href="#" class="container--flex campaign__button button--primary margin--md flex-grow ai--c jc--c flex-grow"><button>Apply Now!</button></a>
								<a href="#" class="container--flex campaign__button button--secondary-light  margin--md flex-grow ai--c jc--c"><button>Be Contacted!</button></a>
							</div>
						</div>
						<div class="spacer--50">
						</div>
