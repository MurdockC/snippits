<?php
	...
	# User
	define('USER_USERNAME','ramsey_user');
	define('USER_PASSWORD','4efb9ddbce6fa0154c2a6e7feacf7049c9c69014');
	...
	# Administrator
	define('ADMINISTRATOR_USERNAME','ramsey_admin');
	define('ADMINISTRATOR_PASSWORD','4efb9ddbce6fa0154c2a6e7feacf7049c9c69014');
	...
	# Paths
	define('SERVER_ADDR','67.205.1.119');
	define('WEBSITE_URL','http://dougandrusdrivingjobs.com/');
	define('ROOT_DIRECTORY','/home/rmwhostedlandingpages/dougandrusdrivingjobs.com/');
	...
	define('DEBUG_MODE','0');
	define('DEMO_MODE','0');
	define('BLOWFISH','f53f47d78512534032febfd4a7fbfd');
?>