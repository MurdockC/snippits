...
if( empty($errors) && empty($bot) ) // Checks to see if there are errors and that the 'content' field is not filled in
	{
		...
		if( empty($companyID) ) {
		    ...
		    // FORM REACTOR - SEND FORM TO CALL TRACKING METRICS FOR PHONE CALLS
				...
				if (strpos($source, 'google-ltl') !== false) {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E46252812CA86B4DCDE51F28734891EF75'); // SocialEdge

				} elseif (strpos($source, 'google-tlx') !== false) {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E419498034324DAB9F988D6901BA57DDE1'); // Google Adwords

				} elseif (strpos($source, 'se-ltl') !== false) {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E4D5BD750184ECE69CB8B74A2067DC7454'); // Indeed

				} elseif (strpos($source, 'se-tlx') !== false) {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E49554B3103460B7A0B7E8318EBC40A20B'); // Jobs2Careers

				} elseif (strpos($whichPage, 'TLX') !== false) {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E455BD65DA5DD234B2A9BF495E1F81BCFD'); // Default Landing page
				} else {
					$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A56BB4D2EF475C8E41C095CA8B329941292067274B4A0E513'); // Default Landing page
				...
				<ApplicationData>
					...
					<DisplayFields>
						...
						<DisplayField>
							...
							<DisplayPrompt>page visited</DisplayPrompt>
