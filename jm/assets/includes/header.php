    ...
    <div class="container full-width light-bg flex centered-contents padding-lg">
      <div class="container width-1200 flex nav">
		...
		-->
		            ...
		            <div class="flex grow-shrink margin-lg flex-column-sm white-text w-45">
  		            <div class="">
										<div class=" padding-sm margin-tb-sm"><h1>HIRING<br> DRIVERS<br>NOW</h1></div>
		                <div class="container flex wrap w-80">
