...
<section id="form" class="element--full-width flex jc--c ai--c">
<form id="quickApp" class="container element--full-width centered-contents padding--tb-xl flex margin--tb-lg flex-column jc--c ai--c" method="post" action="assets/forms/post.php">

	<div class="container full-width text--center jc--c ai--c">
		<h3 class="form__title">Be Contacted</h3>
	</div>
	<div class="container container--1200 flex wrap centered-contents jc--c ai--c">
