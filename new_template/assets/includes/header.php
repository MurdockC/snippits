...
})(window,document,'script','dataLayer','GTM-5J2KMS6');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5J2KMS6"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
	<header>
		<div class=" container w--full bg--white flex ai--c jc--c p--lg">
			<div class="nav container  w--1200 flex">
				<a href="<?php echo $siteURL; ?>"><img id="logo" class="header__logo--img" src="assets/images/dist/logo.png" alt="Company Logo"></a>
				...
				<div class="nav__phone flex">
					<span class="desktop-hidden flex"><a href="#"><button class="button button--primary flex ai--c jc--c p--md m--sm"><span class="desktop-hidden flex">Call Us!</span></button></a></span>
				</div>
				<span class="desktop-visible">
					...
					-->
					<a href="tel:<?php echo $phone; ?>"><button id="phoneNum" class="button button--primary flex ai--c jc--c p--md m--sm"><span class="desktop-visible"><?php echo $phone; ?></span></button></a>
				</span>
			</div>
		</div>
		</div>
		...
		<!-- <div id="thisContent" class="header__nav--mobile container--column-300 container">
			...
			<section id="campaign" class="campaign-bg container w--full flex jc--c ai--c fadeLoad ">
				<div class="w--1081 flex">
					<div id="campText" class=" flex flex-column campaign--container-text hidden">
						<h1 class="p--lg white-text">Feeling Beat Down?</span></h1>
						<h4 class="p--lg campaign-text--secondary">Our drivers don't feel beat hauling sugar beets.  They have motivation and a "can do" attitude hauling sugar beets and aggregate material year round.</h4>
						<!-- <p class="padding--lg padding-tb--none callout-spacing dark-text">We serve lots of outside customers, but within the company, we serve drivers. They come first in every department—dispatch, maintenance, accounting, or management. We’ve found that when we put drivers first, everything else falls into line.</p> -->
							<div class="campaign--container-buttons flex wrap">
								<a href="<?php echo $app; ?>?r=<?php echo $origin; ?>" class="button flex campaign__button button--primary m--lg grow ai--c jc--c grow"><button>Apply Now!</button></a>
								<a href="#form" class="button flex campaign__button button--secondary-light  m--lg grow ai--c jc--c"><button>Be Contacted!</button></a>
							</div>
						</div>
					</div>
