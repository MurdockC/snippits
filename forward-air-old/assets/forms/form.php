...
<form id="quickApp" class="container full-width centered-contents padding--tb-xl container--flex margin--tb-lg container--column" method="post" action="assets/forms/post.php">
	...
	<div class="container width-1200 container--flex wrap">
		...
		<div class="container--flex margin--lg container--column-sm">
			...
			<div class="check-radio-container">
				<input type="radio" id="driver1" name="driver" value="1" required><label  for="driver1">Company Driver</label>
				<input type="radio" id="driver2" name="driver" value="2"><label for="driver2">Owner Operator</label>
				<input type="radio" id="driver3" name="driver" value="3"><label for="driver3">Sub-Contractor/ Fleet Driver</label>
				<input type="radio" id="driver4" name="driver" value="4"><label for="driver4">Lease Purchase</label>
			</div>
