...
<form id="quickApp" class="container full-width primary-bg centered-contents padding-tb-xl flex margin-tb-lg flex-column" method="post" action="assets/forms/post.php">
	...
	<div class="container width-1200 flex wrap">
		...
		<div class="flex margin-lg flex-column-sm">
			...
			<button type="submit" class="button-primary padding-md full-width margin-lg self-centered">Contact Me!</button>
		</div>
	</div>
