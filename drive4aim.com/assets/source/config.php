<?php
	class config {
		...
		protected static $application = "https://intelliapp2.driverapponline.com/c/aimnational?"; 
		
		// GID for google phone # sheet
		protected static $gid = '2014130223'; 		
