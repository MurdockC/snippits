<section class="form-bg quickapp-toggle" id="questions">
	<form id="quickApp" class="app" method="post" action="<?php echo $siteURL; ?>assets/forms/event-post.php">
		<div class="container" style="max-width: 800px;">
			...
			<div>
				...
				<div class="checkRadioBox">
					<input type="radio" id="position-driver" name="position" value="driver" required><label  for="position-driver">Class A Driver</label>
					<input type="radio" id="position-mechanic" name="position" value="mechanic"><label for="position-mechanic">Mechanic</label>
				</div>
