<?php
	$pageName = 'illinois-event';
	$location = 'illinois-event';
  	...
  	<div>
			...
			<div class="flex hiring-event">
				<div class="flex datebox">
					...
					<h1 class="date-title date-hack">5/4</h1>
					<h4 class"">10am - 7pm</h4>
				</div>
				<div class="flex datebox">
					<h4 class="date-title">Saturday</h4>
					<h1 class="date-title date-hack">5/5</h1>
					<h4 class"">9am - 1pm</h4>
				</div>
		...
		<div  class="flex column location">
			<p style="margin-bottom: 20px;">
				Location:<br> <b>Romeoville Shop<br> 1250 Lakeside Drive - Romeoville, IL 60446</b><br><br>
			Stop by and participate in our truckers GPS giveaway!</p>
