...
<body>
<div class="container container-full-width centered-contents flex flex-column  margin-lg paddin-xl">

	<div class="width-1200  self-centered margin-xl flex centered-text">
		<div class="margin-lg">
