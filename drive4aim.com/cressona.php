<?php
	$pageName = 'cressona-event';
	$location = 'cressona-event';
  	...
  	<div>
			...
			<div class="flex hiring-event">
				<div class="flex datebox">
					...
					<h1 class="date-title date-hack">6/8</h1>
					<h4 class"">10am - 7pm</h4>
				</div>
				<div class="flex datebox">
					<h4 class="date-title">Saturday</h4>
					<h1 class="date-title date-hack">6/9</h1>
					<h4 class"">9am - 1pm</h4>
				</div>
		...
		<div  class="flex column location">
			<p style="margin-bottom: 20px;">
				Location:<br> <b>Aim<br> 1182 Route 61  - Pottsville, PA 17901</b><br><br>
