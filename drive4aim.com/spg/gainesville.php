...
<section>
	<div class="container introContainer">
	  	<div>
			<h1>Gainesville, GA</h1>
			<p>Delivery of aluminum to job sites and warehouses.  Leave Sun/Mon - home occasionally thru the week (1 night at a time) home Friday evening or Sat morning.</p>
	    </div>
	</div>
	<div class="container">
			...
			<div class="callout-parent">
				<div class="callout">
					<div class="callout-title">
						...
						<h4>Average $64,000 a year</h4>
					</div>
					<div>
						<p><strong>$1,230 Weekly Average</strong>, all pay is based on mileage and stops.</p>
					</div>
					<div>
				...
				<div class="callout">
					<div  class="callout-title">
						...
						<h4>Home 1-2 nights a week</h4>
					</div>
					<div>
						<p><strong>Multiple stops</strong> in a 100-1000 mile radius.</p>
					</div>
					<div>
						<p><strong>2500-3000</strong> Average miles a week</p>
					</div>
					<div>
						<p><strong>50-70 hours a week</strong></p>
					</div>
				</div>
			</div>
		</div>
