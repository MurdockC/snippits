...
<form id="quickApp" class="o--hidden w--f p-tb--xl flex m-tb--lg column jc--c ai--c" method="post" action="assets/forms/post.php">

	<div class="o--hidden full-width text--center jc--c ai--c">
		<h3 class="form__title">Be Contacted</h3>
	</div>
	<div class="o--hidden w--1200 flex wrap jc--c ai--c">
		...
		<div class="flex m--lg form__column">
			...
			<button style="box-shadow: none;" type="submit" class="button form__button p--lg w--full m--xl self--center">Contact Me!</button>
		</div>
	</div>
</form>
