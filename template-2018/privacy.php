...
<div  class="o--hidden margin--md privacy__info">
	<div class="w--full flex column ai--c jc--c margin--md">
		<div class="w--960 flex column margin--md<?php //showhide for mobile tabs ?>showhide">
		  <h1>Privacy Policy</h1>

			<p>This privacy notice discloses the privacy practices for <?php echo $siteTitle; ?>. This privacy notice applies solely to information collected by this web site. It will notify you of the following:</p>
			...
			<ul>
				...
				<li>Have us delete ano--hidden have about you.</li>
