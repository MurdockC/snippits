<?php
	...
	include('assets/includes/header-reefer.php');
	?>
		...
		<div id="mobile-hide">
			<section id="body-content" class="container element--full-width bg--primary ai--c jc--c flex-column flex padding--xl">
				<div id="benefits" class="container container--960 flex wrap ">
					<p style="color:white;">We serve lots of outside customers, but within the company, we serve drivers. They come first in every department—dispatch, maintenance, accounting, or management. We’ve found that when we put drivers first, everything else falls into line.</p>
				</div>
			</section>
...
<h4 class="padding--lg padding-tb--none margin-tb--lg">Here’s what to expect as a team in our Refrigeration Division:</h4>
				</div>
				<div id="benefits" class="container container--1200 flex wrap ">
					<div class="flex margin--lg container--column-300 column-fix">
						...
						<ul class="margin--sm">
							<li class="margin--tb-md text--left"><b>Up to 50 CPM</b> — Split between the team</li>
							<li class="margin--tb-md text--left"><b>Extra Pay</b> — For layovers, detention, breakdowns, and longevity</li>
						</ul>
          ...
          <div class="flex margin--lg container--column-300 column-fix">
						...
						<ul class="margin--sm margin--md">
							<li class="margin--tb-xs text--left"><b>Driving Area</b> — anywhere in the lower 48 States</li>
							<li class="margin--tb-xs text--left"><b>Hiring Area</b> — CA, OR, WA, ID, UT, AZ, NM, TX, OK, KS, MO, CO, IL, OH, PA, NY (not city), GA</li>
							<li class="margin--tb-md text--left"><b>Road and Home Time</b> ??</li>
						</ul>
						<h4 class="margin--tb-sm text--left ">What’s Required of You</h4>
	 					 <ul class="margin--sm">
							 ...
							 <li class="margin--tb-md text--left">No felonies in 5 years</li>
