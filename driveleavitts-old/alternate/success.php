<?php
	...
	$phone = htmlspecialchars($_GET["recruiterphone"]);
...
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-K8ZZ7W"
...
<div class="container">
	<div id="content">
		...
		<br>
		<a class="button button-primary" href="<?php echo $application; ?>&r=<?php echo $source; ?>">Complete your application</a>
		<br>
		<p>or call <a href="tel:<?php echo $phone_no_string ?>"><?php echo $phone ?></a></p>
	</div>
</div>
