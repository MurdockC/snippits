...
$siteURL = 'http://driveleavitts.com/'; 
...
$notify = 'recruiting@leavitts.com'; 
...
if ($errors) {
	mail("caleb@ramseymediaworks.com", "Landing Page Form Errors", $errors, "MIME-Version: 1.0 \r\n Content-type:text/html;charset=UTF-8 \r\n");
}
if( empty($errors) && empty($bot) ) // Checks to see if there are errors and that the 'content' field is not filled in
	{
		...
		if( empty($companyID) ) {
			...
			/*$curl = curl_init('https://api.calltrackingmetrics.com/api/v1/formreactor/FRT472ABB2C5B9B141A95E7A133293232FBF84BA4CAC72A4DFCCF227EEF2720770F'); // This is unique to each site > Get this link from Numbers > Form Reactors > Edit > REST API at the bottom of the page.
			...
			curl_setopt_array($curl, array(
			  ...
			  CURLOPT_POSTFIELDS => '{ "caller_name":"' . $fullname . '", "phone_number":"' . $phone . '" }', // Pulls in from our form info
		...
		header("Location: {$siteURL}alternate/");
	}
