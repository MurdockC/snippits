...
<main id="main">
    <div class="ten columns">
      	<section>
            ...
            <p>This privacy notice discloses our privacy practices. This privacy notice applies solely to information collected by this web site. It will notify you of the following:</p>
            <ul class="square">
        ...
        <section>
            ...
            <p>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at <a class="phone" href="tel:<?php echo $phone_no_string; ?>"><?php echo $phone; ?></a> or via email.</p>
        </section>
    </div>
