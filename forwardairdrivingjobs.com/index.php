				...
				<section id="body-content" class="container container--full-width light-bg ai--c jc--c container--column container--flex padding--lg">
					<div id="benefits" class="container container--1200 container--flex wrap">
						<div class="container--flex margin--lg container--column-sm">
							...
							<small class="asterisk" style="padding: 0px 40px; margin-bottom: 10px;">Earnings are based off of an estimated 3,000 miles per week and include $0.02 for hazmat and
$0.02 for a truck 5 years old or newer. The estimate is for 52 weeks and includes adjustment for
empty miles and fuel surcharge.</small>
							...
							<div style="margin: 5px 0px -5px 29px; line-height: .5em;">*</div>
							<small class="asterisk" style="padding: 0px 40px; margin-bottom: 10px;">Earnings are based off of an estimated 5,800 miles per week and include $0.02 for hazmat and
...
for empty miles and fuel surcharge.</small>
            ...
            <div class="container--flex margin--lg container--column-sm">
							...
							<div style="margin: 15px 0px -5px 29px; line-height: .5em;">*</div>
							<small class="asterisk" style="padding: 0px 40px; margin-bottom: 10px;">Owner Operators don’t receive benefits directly through Forward Air, but we offer third-party insurance&nbspfor :</small>
							<ul class="margin--sm">
								...
								<h5 style="margin-left: 30px;"class="margin-tb-md">Additional Advantages</h5>
								<ul class="margin--sm">
