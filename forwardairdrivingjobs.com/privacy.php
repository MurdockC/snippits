<?php
	...
	$company = 'forwardairdrivingjobs.com';
?>
<style>
h1, h2 {
	margin-top: 10px;
...
<div class="container margin--md">
	<div class="container--full-width container--flex container--column ai--c jc--c margin--md">
		<div class="container--960 container--flex container--column margin--md<?php //showhide for mobile tabs ?>showhide">
		  <h1>Privacy Policy</h1>

			<p>This privacy notice discloses the privacy practices for <?php echo $company; ?>. This privacy notice applies solely to information collected by this web site. It will notify you of the following:</p>
