...
<div id="content">
<div class="container container--full-width jc--c ai--c container--column container--flex">
				...
				<br><br>
				<a href="<?php echo $app ; ?>?r=rmw_<?php echo $origin ; ?>_successfullapp" style="margin: 20px; min-height: auto; padding: 20px 40px; text-align:center; "class="button button--primary button--campaign margin-md margin-tb-lg flex-grow">Complete your application</a>
				<br><br>
