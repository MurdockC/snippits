...
})(window,document,'script','dataLayer','GTM-WS8VSJ');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WS8VSJ"
...
<div id="content">
<div class="container full-width centered-contents flex-column flex">
				...
				<br><br>
				<a href="<?php echo $app; ?>?r=<?php echo htmlspecialchars($_GET["source"]); ?>_successfullapp" style="margin: 20px; min-height: auto; padding: 20px 40px; text-align:center; "class="button button-primary button-campaign margin-md margin-tb-lg flex-grow">Complete your application</a>
				<br><br>
				<a class="margin-lg" href="tel:<?php echo $phone; ?>"><p><span style="color: black;">or call</span> <?php echo $phone; ?></a></p>
			</div>
		</div>
