...
<footer class="primary-bg container full-width centered-contents">
		<div class="footer-content container width-1200 centered-contents text-center margin-lg">
...
<small><?php echo "&copy; " . date("Y"); ?> <?php echo $company ?> | <a class="link-style" href="/privacy.php">Privacy</a></small>
...
<div class="mobile-nav-footer container container full-width flex">
	<div class="flex flex-column mobile-footer-button padding-md centered-contents"><a href="<?php echo $siteURL ?>"><i class="fa fa-home" aria-hidden="true"></i><br>Home</a></div>
	...
	<div class="flex flex-column mobile-footer-button padding-md centered-contents"><a href="#benefits"><i class="fa fa-plus-circle" aria-hidden="true"></i><br>Benefits!</a></div>
	<div class="flex flex-column mobile-footer-button mobile-footer-apply centered-contents contrast-bg flex2"><a href="<?php echo $app; ?>?r=<?php echo $origin; ?>"><i class="fa fa-sign-in" aria-hidden="true"></i><br>Apply Now!</a></div>
</div>
