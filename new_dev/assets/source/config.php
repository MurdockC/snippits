<?php
	class config {
		...
		// Full url
		protected static $url = 'localhost/template_1';

		// Set Company Name for Page Titles
		protected static $title = 'Template_1';

	    // Set Default Source here - no spaces - domain
		protected static $company  = 'localhost/template_1';

		// Set Cookie Name, just the url, with no http: or .com etc --- And No Spaces
		protected static $name = 'Template_1';
		...
		protected static $siteName = 'template_1.com';
